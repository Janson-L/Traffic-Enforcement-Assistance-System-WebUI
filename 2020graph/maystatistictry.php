...
<html>
  <head>
    ...
    FROM summon LEFT JOIN offense ON summon.OffenseID = offense.OffenseID WHERE YEAR(summon.SummonDateTime) = 2020 AND MONTH(summon.SummonDateTime) = 5 GROUP BY offense.OffenseName, MONTH(summon.SummonDateTime)";
