...
<html>
  <head>
    ...
    FROM summon LEFT JOIN offense ON summon.OffenseID = offense.OffenseID WHERE YEAR(summon.SummonDateTime) = 2021 AND MONTH(summon.SummonDateTime) = 1 GROUP BY offense.OffenseName, MONTH(summon.SummonDateTime)";
        ...
        var options = {
          title: 'TYPE OF SUMMONS WITH TOTAL COUNTS IN JANUARY'
        };
