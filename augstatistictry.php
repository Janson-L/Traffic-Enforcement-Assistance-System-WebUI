...
<html>
  <head>
    ...
    FROM summon LEFT JOIN offense ON summon.OffenseID = offense.OffenseID WHERE MONTH(summon.SummonDateTime) = 8 GROUP BY offense.OffenseName, MONTH(summon.SummonDateTime)";
