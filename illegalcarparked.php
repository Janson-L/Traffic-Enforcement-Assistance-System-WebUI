  ...
  <div class="row">
    ...
    <!--    Letak gambar dekat sini  -->
     ...
     <div class="main-wrapper mx-auto">
        ...
        $sql="SELECT LicensePlate, Location, EntryDateTime, HOUR(TIMEDIFF(EntryDateTime, ADDTIME(CURRENT_TIMESTAMP(), '08:00'))) AS overdue_by FROM camera LEFT JOIN record ON camera.CameraID = record.CameraID WHERE Location='Satria' AND HOUR(TIMEDIFF(EntryDateTime,ExitDateTime))>=8";
