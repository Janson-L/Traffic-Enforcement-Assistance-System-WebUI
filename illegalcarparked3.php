  ...
  <div class="row">
    ...
    <!--    Letak gambar dekat sini  -->
     ...
     <div class="main-wrapper mx-auto">
        ...
        $sql="SELECT LicensePlate, Location, EntryDateTime, HOUR(TIMEDIFF(EntryDateTime, ExitDateTime)) AS overdue_by FROM camera LEFT JOIN record ON camera.CameraID = record.CameraID WHERE Location='Lestari' AND HOUR(TIMEDIFF(EntryDateTime,ExitDateTime))>=8";
