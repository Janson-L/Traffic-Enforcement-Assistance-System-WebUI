...
<html>
  <head>
    ...
    FROM summon LEFT JOIN offense ON summon.OffenseID = offense.OffenseID WHERE MONTH(summon.SummonDateTime) = 5 GROUP BY offense.OffenseName, MONTH(summon.SummonDateTime)";
