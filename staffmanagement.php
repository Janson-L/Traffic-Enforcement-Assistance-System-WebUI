                ...
                <form method='POST'>
                    <div class="form-inline text-center">
                        ...
                        <select name='searchType' class="form-control" required>
                            <option <?php if ($searchType == "staffNameSearch") echo 'selected="selected"'; ?>value='staffNameSearch'>
                                Search by user name</option>
                            <option <?php if ($searchType == "staffIDSearch") echo 'selected="selected"'; ?>value='staffIDSearch'>
                                Search by userID</option>
                        </select>
    </div>
    <div class="form-group">
                        <input type="text" class="form-control" name='searchQuery' value='<?php echo $searchQuery ?>' required pattern="^[A-Za-z0-9 \/@]{1,50}$" maxlength="30">
    </div>
    <div class="form-group">
        ...
        <div class="container text-center">
            ...
            ?>
                <div style="overflow-x:auto;">
                    <table class="centerthistable text-center">
                        <tr>
                            <th>Staff ID</th>
                            <th>Name</th>
                            <th>Phone No</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method='POST' action='deleteStaff.php'>
                                    <input type="text" name="staffID" value="<?php echo $row['staffID']; ?>" style="display:none">
                                    <input type="text" name="name" value="<?php echo $row['name']; ?>" style="display:none">
                                    <input type="submit" name="deleteUser" class="btn btn-danger" value="Delete User">
                                </form>
                            </td>
                        </tr>
                    <?php }
